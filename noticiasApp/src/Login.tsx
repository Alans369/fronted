              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <input value={inputs.clave} 
                    onChange={handleChange}  name="clave" type="password" required className="w-full text-slate-900 text-sm border border-slate-300 px-4 py-3 pr-8 rounded-md outline-blue-600" placeholder="Enter password" />
