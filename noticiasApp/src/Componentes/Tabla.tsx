...
interface param {
    ...
    cambiarBarra: (estado:string,cat: { id: number, nombre: string })=>void
    borrar:(id:number)=>Promise<void>;

}

export const Tabla = ({ data, page, cambiarPagina, cambiarBarra ,borrar}: param) => {
                            ...
                            <tr className="bg-white border-b dark:bg-white-800 dark:border-gray-700 border-gray-200">
                                ...
                                <td className="p-4">
                                    <div className="flex items-center">
                                        <button onClick={() => { cambiarBarra('Edit',{ id: item.id, nombre: item.nombre }) }} className="mr-3 cursor-pointer" title="Edit">
                                        ...
                                        <button onClick={()=>{borrar(item.id)}} title="Delete" className="cursor-pointer">
