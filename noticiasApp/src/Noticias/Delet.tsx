import React, { useContext, useState,useEffect, type FormEvent } from 'react'
...
const Delet = ({ isOpen, onClose,upload }: FormEditProps) => {
    ...
    const context  =useContext(DataContext)
      ...
      const borrar = async (e: FormEvent) => {
          ...
          try {
            const response = await services.delete(noticia.id)
                    ...
                    <div className="w-full max-w-md bg-white shadow-lg rounded-xl p-6 relative">
                        ...
                        <div className="mt-6">
                            ...
                            <div className="mt-4">
                                ...
                                <p className="text-slate-600 text-sm mt-2">{`estas seguro que de seas borar: ${noticia.titulo}`}</p>
                            </div>
